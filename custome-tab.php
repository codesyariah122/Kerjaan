...
function tokoweb_tabs_shortcode() {
	...
	.tokoweb-card {
		...
		color: #fff;
		height: 580px;
		min-height: 650px; /* Menambahkan min-height untuk memastikan tinggi card konsisten */
		border-radius: 10px;
		overflow: hidden;
		display: flex;
	...
	.tokoweb-card-body {
		padding: 10px;
		background-color: #1c1c1c;
		flex-grow: 1; /* Membuat body card fleksibel agar selalu mengisi ruang kosong */
	}
	...
	.tokoweb-card-img {
		...
		object-fit: cover;
		display: block; /* Memastikan gambar berperilaku seperti elemen block */
		background-color: #000; /* Menambahkan latar belakang untuk gambar kosong */
	}
	...
	@media (max-width: 480px) {
		...
		.tokoweb-content {
			grid-template-columns: 1fr; /* 1 card per baris untuk layar ekstra kecil */
		}
...
```Dibawah tab ada container untuk content tab nya``` 
### ELement html nya seperti ini :
<!--<div class="tokoweb-content" id="tokoweb-content">-->
<!--        <div id="genre-tabs" class="tokoweb-genre-tabs"></div>-->
<!--    <div id="genre-posts">Loading konten...</div>-->
<!--</div>-->
<div class="genre-tabs-wrapper">
    <div id="genre-tabs"></div> <!-- This should contain the genre tabs -->
</div>
<div class="tokoweb-content-wrapper">
    <div id="tokoweb-content"></div> <!-- This should contain the content like posts -->
</div>
