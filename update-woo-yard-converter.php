...
function woo_converter_input_fields_conditional()
{
    ...
    <div class="woo-converter-wrapper">
        ...
        <p id="price-per-yard-display"
            ...
            <?php if ($default_unit === 'yard'): ?>
                Harga per Yard: Rp <?php echo number_format($price_per_yard, 0, ',', '.'); ?> / Yard
            <?php else: ?>
                Harga per Kilogram: Rp <?php echo number_format($price_per_kg, 0, ',', '.'); ?> / Kg
            <?php endif; ?>
        </p>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function updatePrice(variation) {
                ...
                if (priceElem) {
                    ...
                    priceDisplay.textContent = 'Harga per ' + unitLabelText + ': Rp ' +
                        Math.round(variation.display_price).toLocaleString('id-ID') + ` / ${unitLabelText} (Bruto)`;
                }
            ...
            meterInput.addEventListener('input', function() {
                ...
                let totalPrice = pricePerUnit * yardVal;

                priceDisplay.textContent = `Harga total: Rp ${totalPrice.toLocaleString('id-ID')} (${yardVal.toFixed(2)} ${unit})`;
