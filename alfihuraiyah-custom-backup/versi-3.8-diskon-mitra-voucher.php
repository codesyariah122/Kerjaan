/**
 * Plugin Name: Override Voucher Mitra (v3.8 Ultimate DOM Fix)
 * Description: Versi paling stabil. Menghapus elemen YITH bawaan dan menyisipkan blok Skema Pembayaran Mitra (Bahasa Indonesia) secara dinamis — 100% tampil di semua tema.
 * Version: 3.8
...
add_action('wp_footer', function () {
    ...
    window.addEventListener("load", function(){
        ...
        // Pantau perubahan DOM (variasi produk, dll)
        const obs = new MutationObserver(renderMitraBlock);
