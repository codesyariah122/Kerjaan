/**
 * Plugin Name: Override Voucher Mitra (v3.2 Hybrid)
 * Description: Kombinasi dari versi lama (admin kupon Diskon Mitra) dan v3.1 (override YITH full Bahasa Indonesia).
 * Version: 3.2
 * Author: Puji Ermanto | UCOK AKA
 */

/* =====================================================
   🔧 BAGIAN ADMIN: Tambah tipe kupon Diskon Mitra
===================================================== */
...
// Simpan nilai field Diskon Mitra
...
/* =====================================================
   🧩 BLOK TAMPILAN PEMBAYARAN MITRA (Bahasa Indonesia)
===================================================== */
...
/* =====================================================
   🚫 NONAKTIFKAN TAMPILAN YITH DEPOSIT OTOMATIS
===================================================== */
add_action('plugins_loaded', function () {
	...
	add_filter('wc_get_template', function ($template, $template_name) {
		if (strpos($template_name, 'deposit-options') !== false) {
...
/* =====================================================
   🧱 INJECT BLOK PEMBAYARAN MITRA DI HALAMAN PRODUK
===================================================== */
